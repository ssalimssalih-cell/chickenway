...
function initApp() {
    ...
    // Vérifier que les fonctions auth sont disponibles
        ...
        if (user) {
            ...
            db.collection('users').doc(user.uid).get().then(function(doc) {
                ...
                if (userData.authorized !== 'yes') { 
                    ...
                    showAuthPage(); 
                    setTimeout(function() {
                        if (typeof showLoginError === 'function') showLoginError('Compte en attente de validation.');
                    }, 300);
                    return; 
                }
                ...
                if (userData.role === 'client') {
                    if (typeof showClientPage === 'function') showClientPage();
                } else {
...
function showClientPage() {
    ...
    if (typeof updateClientSidebarInfo === 'function') updateClientSidebarInfo(); 
