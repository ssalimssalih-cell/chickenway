...
function initApp() {
    ...
    // Afficher la page d'authentification par défaut
...
function navigateTo(page) {
    ...
    var titles = {
        dashboard:'Dashboard',pos:'Point de Vente',commandes:'Commandes en ligne',
    ...
    // Router vers les fonctions appropriées
    ...
    else content.innerHTML = '<div class="content-card"><h3>' + (titles[page]||'Page') + '</h3><p style="text-align:center;padding:40px;color:#94a3b8;">En développement</p></div>';
}
