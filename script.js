...
function navigateTo(page) {
    ...
    var titles = {dashboard:'Dashboard',pos:'Point de Vente',commandes:'Commandes en ligne',categories:'Categories',products:'Produits',clients:'Clients',fournisseurs:'Fournisseurs',ventes:'Ventes',credits:'Credits',depenses:'Depenses',statistiques:'Statistiques',options:'Options'};
