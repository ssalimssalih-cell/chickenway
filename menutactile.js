...
// ==================== FERMETURE ET PLEIN ÉCRAN ====================
function closeMenuTactile() {
    // Retour à la page d'accueil sans paramètre table
...
function initMenuTactile(tableNum) {
    ...
    // Activer le plein écran au premier toucher
...
function renderMenuTactile() {
    ...
    // ========== EN-TÊTE AVEC BOUTON X ET LOGO CENTRÉ ==========
    ...
    html += '<img src="logo.png" alt="Chicken Way" style="width:80px; height:80px; border-radius:50%; border:4px solid #fff; box-shadow:0 4px 15px rgba(0,0,0,0.3); object-fit:cover; background:#fff;" onerror="this.style.display=\'none\'">';
    html += '</div>';
...
console.log('🍽️ Menu Tactile Chicken Way - Prêt (avec fermeture et plein écran)');
