...
async function posFinalizeSale(){
    ...
    try{
        ...
        var itemsDetail=posCart.map(function(it){return{id:it.id,nom:it.nom,quantite:it.quantite,prixVente:it.prixUnitaire,prixAchat:it.prixAchat||0,sauces:it.sauces||[],interdits:it.interdits||[],epice:it.epice||'Normal',sel:it.sel||'Normal'};});
